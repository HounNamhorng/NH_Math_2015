...
{
    public partial class Minus4X2 : Form
    {
        public Minus4X2()
        {
            InitializeComponent();
        ...
        {
            double a11, a12, a21, a22, a31, a32, a41, a42, b11, b12, b21, b22, b31, b32, b41, b42;
            ...
            txtr7.Text = (a41 - b41).ToString();
            txtr8.Text = (a42 - b42).ToString();
        }
        ...
        private void txta32_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
                SendKeys.Send("{Tab}");
